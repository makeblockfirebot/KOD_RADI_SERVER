...
void setup() {
  ...
  webPage += "<h1>Drzava: </h1>";
  webPage += country;
  webPage +="<h1>Grad: </h1>";
  webPage += city;  


  webPage += "<h1>Longitude: </h1>";
  webPage += longitude;
  webPage +="<h1>Latitude: </h1>";
  webPage += latitude;

  webPage += "<h1>Smijer vjetra: S </h1>";
  webPage += "<h1>Brzina vjetra: 11 km/h </h1>";
  ...
  Serial.println(WiFi.localIP());
   server1.on("/", [](){
    server1.send(200, "text/html", webPage);
  });
